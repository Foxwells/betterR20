...
VERSION_NUMBER = /* 5ETOOLS_VERSION__OPEN */"1.117.2"/* 5ETOOLS_VERSION__CLOSE */;
...
BrewUtil = {
	...
	async _pRenderBrewScreen_pRefreshBrewList ($brewList) {
		...
		brewSources.forEach((src, i) => {
			...
			const $row = $(`<li class="manbrew__row lst--border">
		...
		const createGroupRow = (fullText, modeProp) => {
			const $row = $(`<div class="manbrew__row flex-h-right">
